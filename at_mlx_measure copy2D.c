...
{
	double 	first_y_intersection = su->player_orient > 0 && su->player_orient < M_PI ? (int)(su->player_y - 1): (int)(su->player_y + 1);
	double 	first_x_intersection = su->player_x + (su->player_y - first_y_intersection) / tan(su->player_orient);
	printf("first_x_intersection : %f\n",first_x_intersection);
